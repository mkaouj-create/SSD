...
export const Layout = () => {
  ...
  const navigation = [
    ...
    // Masquer Doublons pour les rôles qui ne gèrent pas les dossiers (mais visible pour Super_admin s'il a la permission)
    if (item.name === 'Doublons' && !hasPermission('manage_dossiers')) return false;
